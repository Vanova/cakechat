...
LOG_TO_FILE_FREQUENCY_PER_BATCHES = 350#2500  # How many batches to train until next logging of all the output into file
SAVE_MODEL_FREQUENCY_PER_BATCHES = 350#2500  # How many batches to train until next logging of all the output into file
